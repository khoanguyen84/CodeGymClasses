...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>wealthland.vn</h1><i></i>
            <h2 id="pathName"><i></i></h2>
        </div>
        <div class="row message">
            <p>Website <span id="website" style="word-break:break-all;"></span> is under construction! contact <span style="font-weight: bold;">sluzzba@gmail.com</span> for any question.</p>
        </div>
        <div class="col-xs-12">
            <h2>What's next?</h2>
        </div>
